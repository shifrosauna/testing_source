    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="stat-filters-form" action="/stat/load" method="POST">
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body" style="padding: 5px 15px;">
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="agregate[]" value="hour" class="data-params" />Время
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                ...
                                <div class="panel-footer" style="display:inline-block; padding: 0 15px; width: 100%">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="fields[]" value="clicks" class="data-params" checked="checked" />Клики
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="fields[]" value="installs" class="data-params" checked="checked" />Установки
                                            </label>
                                        </div>
										<div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="fields[]" value="conversions" class="data-params" checked="checked" />Активации
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="fields[]" value="cr" class="data-params" />% активаций
                                            </label>
                                        </div>
                                        <!--div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="fields[]" value="rpc" class="data-params">RPC
                                            </label>
                                        </div-->
                                    </div>
                                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-stat">
                        <thead>
                            <tr>
                                ...
                                <th>Установки</th>
                                <th>Активации</th>
								<?php if ($view->_admin): ?><th>Показы</th><?php endif; ?>
                                <th>Выплата</th>
                            </tr>
                        </thead>
                        <tbody>
