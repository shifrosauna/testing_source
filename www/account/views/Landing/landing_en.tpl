<div class="info container">
            ...
            <span class="free_cost font_color_orange">Free</span>
        </div>
        <div class="container">
            <div class="info_rating">
                <div class="rating_form_disable"></div><span class="inst_val">157 875</span>
            </div><a href="<?php echo $view->apk->url; ?>" class="button">Download</a>
            <ul class="properties">
                <li>The application is compatible with your device</li>
                <li>The free app</li>
            </ul>
        </div>
        ...
        <div class="container"><a href="<?php echo $view->apk->url; ?>" class="button">Download</a></div>
        <?php endif; ?>
        ...
        <div class="description container container_shadow">
            ...
            <a href="<?php echo $view->apk->url; ?>" class="button">Download</a>
        </div>
