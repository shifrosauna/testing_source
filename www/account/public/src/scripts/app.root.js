(function () {
    ...
    RootCtrl.$inject = ['$scope', '$rootScope', '$localStorage', '$timeout', '$translate', 'Fullscreen', '$q', '$window', '$location'];

    function RootCtrl($scope, $rootScope, $localStorage, $timeout, $translate, Fullscreen, $q, $window, $location) {

        if (!$rootScope.user && !$window.user) {
