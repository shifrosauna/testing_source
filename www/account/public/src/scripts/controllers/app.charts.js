        ...
        .controller('ChartsCtrl', ['$scope', function ($scope) {
                ...
                line: {
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            {
                                label: "Example dataset",
                                fillColor: "rgba(149,229,120,0.5)",
                                strokeColor: "rgba(149,229,120,0.7)",
                                pointColor: "rgba(149,229,120,1)",
                                pointStrokeColor: "#fff",
                                pointHighlightFill: "#fff",
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            },
                            {
                                ...
                                fillColor: "rgba(149,229,120,0.5)",
                                strokeColor: "rgba(149,229,120,0.8)",
                                highlightFill: "rgba(149,229,120,0.75)",
                                highlightStroke: "rgba(149,229,120,1)",
                                data: [28, 48, 40, 19, 86, 27, 90]
                            }
                        ]
                    }
                ...
                radar: {
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            {
                                label: "My Second dataset",
                                fillColor: "rgba(1,122,255,0.2)",
                                strokeColor: "rgba(1,122,255,1)",
                                pointColor: "rgba(1,122,255,1)",
                                pointStrokeColor: "#fff",
                                pointHighlightFill: "#fff",
            ...
            $scope.sparkline = {
                inline1: {
                    ...
                    data: [34, 43, 43, 35, 44, 32, 44, 52, 25]
                },
                inline2: {
                    options: {
                        type: 'bar',
                    ...
                    data: [5, 6, 7, 2, 0, -4, -2, 4]
                },
                pie: {
                    data: [1, 1, 2],
                    options: {
                        type: 'pie',
                        sliceColors: ['#007aff', '#b3b3b3', '#e4f0fb']
                    }
                },
                line: {
                    data: [34, 43, 43, 35, 44, 32, 15, 22, 46, 33, 86, 54, 73, 53, 12, 53, 23, 65, 23, 63, 53, 42, 34, 56, 76, 15, 54, 23, 44],
                    options: {
                        type: 'line',
                        lineColor: '#007aff',
                        fillColor: '#ffffff'
                ...
                bigpie: {
                    ...
                    options: {
                        type: 'pie',
                        height: '150px',
                        sliceColors: ['#007aff', '#3395ff', '#0162cc']
                    }
                },
                bigbar: {
            ...
            $scope.morris = {
                area: {
                    ...
                    hideHover: 'auto',
                    resize: true,
                    lineColors: ['#017aff', '#3395ff', '#0162cc'],
                    lineWidth: 2
                },
                bar: {
                    data: [
            ...
            function sampleData3() {
                return [
                    ...
                    },
                    {
                        key: "Line 2",
                        values: [
                            {x: 1, y: 11, shape: "circle", size: 1},
                            {x: 2, y: 10, shape: "cross", size: 1.5},
                            {x: 3, y: 13, shape: "triangle-up", size: 2},
                            {x: 4, y: 15, shape: "triangle-down", size: 2.5},
                            {x: 2, y: 12, shape: "diamond", size: 3},
                            {x: 3, y: 11, shape: "square", size: 3.5}
                        ],
                        slope: 1.5,
                        intercept: 8,
                    }
                ].concat(randomData(3, 5));
            }
