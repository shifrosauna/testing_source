(function () {
    ...
    angular.module('app.form.validation', ['validator', 'validator.rules']).config(function ($validatorProvider) {
        ...
        .controller('FormValidationCtrl', function ($scope, $filter, $http, $validator) {
            $scope.formWatch = {
                required: '',
                regexp: '',
                requiredRun: '',
